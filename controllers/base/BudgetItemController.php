...
use app\models\search\BudgetItemSearch;
use app\models\form\BudgetItemForm;
...
class BudgetItemController extends Controller
{
    ...
    /**
     * Lists all active BudgetItem models.
     * @return mixed
     */
    public function actionIndex()
    {
        ...
        $actionControl = BudgetItemActControl::checkAccess('index', $searchModel);
    ...
    /**
     * Lists deleted active BudgetItem models.
     * @return mixed
     */
    public function actionDeleted()
    {
        ...
        $actionControl = BudgetItemActControl::checkAccess('deleted', $searchModel);
    ...
    public function actionView($id)
    {
        ...
        $actionControl = BudgetItemActControl::checkAccess('view', $model);
    ...
    {
        $model = new BudgetItemForm;
        $actionControl = BudgetItemActControl::checkAccess('create', $model);
    ...
    public function actionUpdate($id)
    {
        ...
        $actionControl = BudgetItemActControl::checkAccess('update', $model);
    ...
    public function actionDelete($id)
    {
        try {
            ...
            BudgetItemActControl::checkAccess('delete', $model);
    ...
    /**
     * Restores an deleted BudgetItem model.
    ...
    public function actionRestore($id)
    {
        try {
            ...
            BudgetItemActControl::checkAccess('restore', $model);
    ...
    /**
     * Finds the BudgetItem form model for modification.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return BudgetItemForm the loaded model
     * @throws HttpException if the model cannot be found
     */
    protected function findForm($id)
    {
        if (($model = BudgetItemForm::findOne($id)) !== null) {
            return $model;
        } else {
            throw new HttpException(404, 'The requested page does not exist.');
        }
