...
class AccountController extends Controller
{
    ...
    /**
     * Lists all active Account models.
     * @return mixed
     */
    public function actionIndex()
    {
        ...
        $actionControl = AccountActControl::checkAccess('index', $searchModel);
    ...
    /**
     * Lists deleted active Account models.
     * @return mixed
     */
    public function actionDeleted()
    {
        ...
        $actionControl = AccountActControl::checkAccess('deleted', $searchModel);
    ...
    public function actionView($id)
    {
        ...
        $actionControl = AccountActControl::checkAccess('view', $model);
    ...
    public function actionCreate()
    {
        ...
        $actionControl = AccountActControl::checkAccess('create', $model);
    ...
    public function actionUpdate($id)
    {
        ...
        $actionControl = AccountActControl::checkAccess('update', $model);
    ...
    public function actionDelete($id)
    {
        try {
            ...
            AccountActControl::checkAccess('delete', $model);
    ...
    /**
     * Restores an deleted Account model.
    ...
    public function actionRestore($id)
    {
        try {
            ...
            AccountActControl::checkAccess('restore', $model);
    ...
    /**
     * Finds the Account form model for modification.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return AccountForm the loaded model
     * @throws HttpException if the model cannot be found
     */
