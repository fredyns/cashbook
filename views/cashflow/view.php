...
?>
<div class="giiant-crud cashflow-view">
    ...
    <?php $this->beginBlock('app\models\Cashflow'); ?>    
    <?=
    DetailView::widget([
        'model' => $model,
        'attributes' => [
            ...
            [
                'linkActControl' => 'app\actioncontrols\CashflowTypeActControl',
            ...
            // generated by fredyns\suite\giiant\crud\providers\core\RelationProvider::attributeFormat
            [
                'linkActControl' => 'app\actioncontrols\AccountActControl',
                'attribute' => 'account',
            ],
            'approved_at',
            'approved_by',
            ...
            [
                'attribute' => 'approval',
                'value' => \app\models\Cashflow::getApprovalValueLabel($model->approval),
            ],
            'notes:ntext',
        ],
    ]);
    ...
    $addCashflowDetail = $CashflowDetailActControl->button('create', [
        ...
        'urlOptions' => [
            'CashflowDetailForm' => ['cashflow_id' => $model->id],
        ],
    ]);
    ...
    Tabs::widget([
        ...
        'items' => [
            [
                ...
                'content' => $this->blocks['app\models\Cashflow'],
                'active' => true,
            ],
            [
