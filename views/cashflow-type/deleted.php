...
/* @var $searchModel app\models\search\CashflowTypeSearch */

$this->title = Yii::t('app', 'Cashflow Types');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="giiant-crud cashflow-type-deleted">

    <h1>
        <?= Yii::t('app', 'Cashflow Types') ?>
        <small class="badge">
            Deleted
        </small>
    </h1>
