...
/**
 * MonthlyBudgetItem model action control
 *
 * @author Fredy Nurman Saleh <email@fredyns.net>
 *
 * @property MonthlyBudgetItem $model data model
 */
class MonthlyBudgetItemActControl extends \fredyns\suite\libraries\ActionControl
{
